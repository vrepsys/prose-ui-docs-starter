...
<Cards
  content={[ 
  { icon: BookOpen, title: 'Prose UI', description: 'Start exploring Prose UI concepts and examples.', url: 'https://prose-ui.com', },
  { icon: PanelsTopLeft, title: 'Templates', description: 'Start quickly with one of the templates.', url: 'https://prose-ui.com/templates', },
  { icon: Shapes, title: 'Components', description: 'Browse and explore Prose UI components.', url: 'https://prose-ui.com/docs/components/overview', }
  ]}
/>
